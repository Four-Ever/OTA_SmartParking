...
const Ifx_Shell_Command g_shellCommands[] = {{COMMAND_INFO, COMMAND_INFO_HELP_TEXT, &g_shellInterface, &printShellInfo},
        {COMMAND_TOGGLE, COMMAND_TOGGLE_HELP_TEXT, &g_shellInterface, &toggleLEDShell}, {COMMAND_HELP,
        COMMAND_HELP_HELP_TEXT, &g_shellInterface, &Ifx_Shell_showHelp}, {COMMAND_DBMSG, COMMAND_MSG_LIST,
                &g_shellInterface, &showMsgSignal},
...
//
//        IfxStdIf_DPipe_read(&g_ascStandardInterface, &p_gain, &readCount, 0);
...
void printInfo (IfxStdIf_DPipe *io)
{
    ...
    IfxStdIf_DPipe_print(io,
            "In order to toggle the LED enter the command '" COMMAND_TOGGLE "' followed by one of the "ENDLINE);
...
void initSerialInterface (void)
{
    ...
    .ctsMode = IfxPort_InputMode_pullUp, .rx = &IfxAsclin3_RXD_P32_2_IN, /* Select the pin for RX connected to the USB port      */
...
{
    PRINT_ALL_SIGNAL(&g_ascStandardInterface, 1, "%d", *cur_count);
}

float value1 = 0;
sint32 value2 = 0;
void print_enc (IMU *imu_data, Euler *euler_data)
{
