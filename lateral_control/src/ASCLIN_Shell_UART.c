...
void print_steering(float *steering_angle){
    PRINT_ALL_SIGNAL(&g_ascStandardInterface, 1, "Steering Angle: %.2f", *steering_angle);

}
void print_x(float *steering_angle){
    PRINT_ALL_SIGNAL(&g_ascStandardInterface, 1, "x: %.2f", *steering_angle);

}
void print_y(float *steering_angle){
    PRINT_ALL_SIGNAL(&g_ascStandardInterface, 1, "y: %.2f", *steering_angle);

}
void print_v(double *steering_angle){
    PRINT_ALL_SIGNAL(&g_ascStandardInterface, 1, "v: %.2f", *steering_angle);
