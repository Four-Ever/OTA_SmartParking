...
#define LCF_INTVEC0_START   0x80061000
#define LCF_INTVEC1_START   0x80062000
#define LCF_INTVEC2_START   0x80060000



#define LCF_TRAPVEC0_START  0x80000100
#define LCF_TRAPVEC1_START  0x80063200
#define LCF_TRAPVEC2_START  0x80063000
...
derivative tc27D
{
    ...
    memory pfls0
    {
        ...
        size = 400k;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80000000,           size=400k);
        map not_cached (dest=bus:sri, dest_offset=0xa0000000, reserved, size=400k);
    }
...
#           include "inttab2.lsl"
    ...
    {       
        ...
        group  bmh_1 (ordered, run_addr=0x80050000)
        {
            select "*.bmhd_1";
        }
